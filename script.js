        ...
        (async function() {
          try {
            ...
            const response = await fetch('https://qaapi.zappy5.com/api/email/contact-form', {
              ...
              body: JSON.stringify({
                websiteId: '0c2189cb-692f-49eb-ba03-3bc15c248c75',
                name: data.name || '',
                email: data.email || '',
            ...
            if (response.ok) {
              ...
              console.log('❌ Zappy: Server returned error status', response.status);
            }
          } catch (error) {
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Zappy uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
